            ...
            <div class="col-sm-9">
                                ...
                                <div class="card-body">
                                    <div id="doctor_table_filter" class="dataTables_filter">
                                        <label for="search" style="display: inline-block; margin-bottom: .5rem;">
                                            Search: <input type="search" class="form-control form-control-md" placeholder="Type Doctor or Patient Name" aria-controls="appointment_table" name="appointment_search" id="search_appointment" style="margin-left: 0.5em; display: inline-block; width: auto;">
                                        </label>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered" id="appointment_table" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-end">
                        <li class="page-item">
                            <a class="page-link" href="admin_appointment.php?page=<?php echo $previous ?>" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <?php for ($i = 1; $i <= $pages; $i++) : ?>
                            <li class="page-item"><a class="page-link" href="admin_appointment.php?page=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php endfor; ?>
                        <li class="page-item">
                            <a class="page-link" href="admin_appointment.php?page=<?php echo $next ?>" aria-label="Next">
            ...
            $("#search_appointment").keyup(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        $("#appointment_table").html(response);
                    }
